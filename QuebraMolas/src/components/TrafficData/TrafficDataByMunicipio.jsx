...
const TrafficDataByMunicipio = ({ municipio }) => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      setError(null);
      try {
        const response = await axios.get(`https://quebra-molas-backend.onrender.com/traffic/municipio/${municipio}`);
  ...
  return (
    <div>
      <h2>Gráfico de Acidentes no município: {municipio}</h2>
...
export default TrafficDataByMunicipio;
